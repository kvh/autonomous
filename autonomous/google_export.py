...
class Event(PydanticBase):
    ...
    table: Table
    file: File
    event_type: EventType = EventType.TableUpdate
...
class ExportToSheets(PydanticBase):
    table_to_export: Table
    spreadsheet_url: str
    sheet_title: str
    connection: Connection("google-sheets")
...
# def export_to_sheets(spreadsheet_url: str, sheet_title: str, connection: Connection("google-sheets")):
